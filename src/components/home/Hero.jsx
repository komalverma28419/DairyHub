...
const Hero = () => {
  return (
    <section className='py-12 md:py-16 px-6 md:px-10 lg:px-16 xl:px-20 bg-cover bg-center bg-no-repeat min-h[70vh] lg:min-h-screen flex items-center' style={{backgroundImage: `url(${BgImg})`}}>
